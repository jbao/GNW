...
%\begin{figure}[ht]
%\begin{center}
<<label=hdf,echo=False,fig=True,eval=True>>=
ts <- read.delim('~/data/DREAM/gnw/scalefree2/gnw/Size1000/mds/scalefree2-1_perturbation-1_1000_normed.dat',sep='|') 
pval <- read.delim('~/data/DREAM/gnw/scalefree2/gnw/Size1000/mds/pval_scalefree2-1_perturbation-1_1000.dat',header=F) 
elist <- read.delim('~/data/DREAM/gnw/scalefree2/gnw/Size1000/scalefree2-1_1000.tsv',header=F)
